...
class Minesweeper():
#mine_config
    def __init__(self, height=8, width=8, mines=13): 
...
class Sentence():
    ...
    def known_mines(self):
        ...
        if len(self.cells) == self.count and self.count != 0:
            print('Xác nhận được mìn! - ', self.cells)
            return self.cells
        else:
            return set()
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        print(f'Di chuyển vào ô: {cell} đã đưa sentence vào knowledge {new_sentence_cells} = {count}' )
                ...
                for sentence_2 in self.knowledge:
                    ...
                    if sentence_1.cells.issubset(sentence_2.cells):
                        ...
                        if new_sentence not in self.knowledge:
                            knowledge_changed = True
                            print('New Inferred Knowledge: ', new_sentence, 'từ', sentence_1, ' và ', sentence_2)
                            self.knowledge.append(new_sentence)

        # Print out AI current knowledge to terminal:
        print('Độ dài KB AI hiện tại: ', len(self.knowledge))
        print('Mìn đã biết: ', self.mines)
        print('Số lượng di chuyển an toàn còn lại: ', self.safes - self.moves_made)
        print('====================================================')
    ...
    def make_safe_move(self):
        ...
        if safe_moves:
            print('Tìm ra ô an toàn. Số ô an toàn còn lại: ', len(safe_moves))
